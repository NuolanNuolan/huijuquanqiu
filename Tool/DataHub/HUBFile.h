...
+ (void) getFilesWithCompletion:(HUBArrayResultBlock)completionBlock;
- (NSURL *) fileURL;
...
- (void) uploadFileWithPermissions:(NSDictionary *)permissions completion:(HUBObjectResultBlock)completionBlock;
...
- (void) deleteFileWithCompletion:(HUBBooleanResultBlock)completionBlock;
+ (void) deleteFileWithId:(NSString *)fileId completion:(HUBBooleanResultBlock)completionBlock;
